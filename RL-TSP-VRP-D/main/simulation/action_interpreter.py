...
class BaseActionInterpreter:
    ...
    def init_coord_act(self, val_output_set, binary_output_set):
        ...
        if 'move' in binary_output_set:
            self.prep_action('move', 2, 'coord_binary', self.binary_check)
        ...
        # automate:
            ...
            self.func_dict['coord'] = self.auto_coord
    ...
    def init_cargo_act(self, val_output_set, binary_output_set):
        ...
        if 'load_sep_unload' in binary_output_set:
            self.prep_action('load_sep_unload', 2, 'load_binary', self.binary_check)
            self.prep_action('load_sep_unload', 2, 'unload_binary', self.binary_check)

        elif 'load_unload' in binary_output_set:
            self.prep_action('load_sep_unload', 2, ['load_binary','unload_binary'], self.binary_check)
        ...
        # automate
            ...
            self.func_dict['load'] = self.auto_amounts
            self.func_dict['unload'] = self.auto_amounts
    ...
    def init_v_transport_act(self, val_output_set, binary_output_set):
        ...
        if 'v_load_sep_unload' in binary_output_set:
            self.prep_action('v_load_sep_unload', 2, 'v_load_binary', self.binary_check)
            self.prep_action('v_load_sep_unload', 2, 'v_unload_binary', self.binary_check)

        elif 'v_load_unload' in binary_output_set:
            self.prep_action('v_load_sep_unload', 2, ['v_load_binary','v_unload_binary'], self.binary_check)
